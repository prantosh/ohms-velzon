...
return new class extends Migration {
    ...
    {
        Schema::create('impression_masters', function (Blueprint $table) {
            ...
            // (see ImpressionMasterController's 'unique:impression_masters,name'
    ...
    {
        Schema::dropIfExists('impression_masters');
    }
};
