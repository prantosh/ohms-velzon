...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        try {
            ...
            Schema::create('usg_report_findings', function (Blueprint $table) {

                $table->id();

                // One report per billed USG line (not per invoice -- an
                // invoice with multiple USG studies gets a separate report
                // per study, confirmed with the user).
    ...
    {
        Schema::dropIfExists('usg_report_findings');
    }
};
