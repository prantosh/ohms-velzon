...
return new class extends Migration {
    ...
    {
        Schema::create('detail_range_masters', function (Blueprint $table) {
            ...
            // (see DetailRangeMasterController's 'unique:detail_range_masters,name'
    ...
    {
        Schema::dropIfExists('detail_range_masters');
    }
};
