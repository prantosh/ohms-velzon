...
if (document.getElementById('personalDetailsForm')) {
    document.getElementById('personalDetailsForm').addEventListener('submit', function (e) {
        ...
        var avatarInput = document.getElementById('profile-img-file-input');
        ...
        fetch(updateUrl, {
            ...
            .then(function (result) {
                if (result.ok && result.data.status) {
                    ...
                    var msg = result.data.message || 'Unable to update profile.';
        ...
        fetch(updateUrl, {
            ...
            .then(function (result) {
                if (result.ok && result.data.status) {
                    ...
                    var msg = result.data.message || 'Unable to update password.';
                    if (result.data.errors) {
                        msg = Object.values(result.data.errors).flat().join('\n');
                    }
                    Swal.fire({
