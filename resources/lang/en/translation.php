...
return [
    ...
    "doctorspecialisation" => "Specialisation Master",
    "doctorhistory" => "Doctor Visit History",
    "doctorpaymenthistory" => "Doctor Payment History",
    "doctorpayable" => "Doctor Payable",
    "doctorpayablestatusall" => "Doctor Payable Status (All)",
    "doctorsettlement" => "Doctor Payable Settlement (User/Doctor)",
    "equipmentrent" => "Equipment Rent",
    "mastermanagement" => "Master Management",
    "billing" => "Billing",
    "equipmentcategorymaster" => "Equipment Category Master",
    "equipmentrenttransaction" => "Issue / Return Equipment",
    "ambulancerent" => "Ambulance Rental",
    "ambulancedestinationmaster" => "Ambulance Destination Master",
    "ambulancerentalinvoice" => "Ambulance Rental Invoice",
    ...
    "inventoryitemmaster" => "Inventory Item Master",
    ...
    "patientcardmaster" => "Patient Card Master",
    "expenditurecategorymaster" => "Expenditure Category Master",
    "expenditureagencymaster" => "Expenditure Agency Master",
    "expenditureentry" => "Expenditure Entry",
    "incomecategorymaster" => "Income from Other Source Category Master",
    "incomeentry" => "Income from Other Source Entry",
    "invoicecancellation" => "Invoice Cancellation",
    "cancellationpermission" => "Cancellation Permission",
    ...
    "userinvoicereport" => "Reconciliation for any User",
    "allinvoicesreport" => "All Invoices for Any Day",
    "doctorsettlementbyuser" => "Doctor Settlement (By User)",
    "doctorpayablebyuser" => "Doctor Payable Status (By User)",
    "dailycashsettlement" => "Daily Cash Settlement",
    "testreportdeliveryreport" => "Test Report Delivery Log",
    "cashsubmissionreport" => "Daily Cash Submission",
    "employeeperformance" => "Employee Performance",
    "reportinggroupmaster" => "Reporting Group Master",
    "doctorconsultationlist" => "Doctor Consultation List",
    "doctorvisitpaymentreport" => "Doctor Visit Payment Report",
    "doctortestpaymentreport" => "Doctor Test Payment Report",
    "doctorpaymentreport" => "Doctor Payment Report (Visit and Test)",
    "doctorpayablenoncashreport" => "Doctor Payable Report (Non-Cash Invoices)",
    "doctorwisepaymentreport" => "Doctor Wise Payment Report",
    "dailytransactionreport" => "Daily Transaction Detail",
    "whatsappmessagereport" => "Whatsapp Message Detail",
    "itemwisereport" => "Category-wise Summary & Detail",
    "monthlyreconciliationreport" => "Monthly Reconciliation Statement",
    "reportinggroupsummaryreport" => "Group-wise Summary for All Users",
    ...
    "testdetailmaster" => "Test Detail Master",
    "testgroupmaster" => "Test Group Master",
    "usgreporttemplate" => "USG Report Template Master",
    "cardiologyreporttemplate" => "Cardiology Report Template Master",
    "testreporttemplate" => "Test Report Template Master",
    "pathologyreporttemplate" => "Pathology Report Template Master",
    "nonpathologyreporttemplate" => "Non-Pathology Report Template Master",
    "testextrafieldtype" => "Test Extra Field Master",
    "instrumentmaster" => "Instrument Master",
    "kitmaster" => "Kit Master",
    "notemaster" => "Note Master",
    "remarksmaster" => "Remarks Master",
    "microscopymaster" => "Microscopy Master",
    "impressionmaster" => "Impression Master",
    "findingmaster" => "Finding Master",
    "detailrangemaster" => "Detail Range Master",
    "samplemaster" => "Sample Master",
    "uommaster" => "UOM Master",
    "testparametermaster" => "Test Parameter Master",
    "testresultentry" => "Test Result Entry",
    ...
    "doctorcalender" => "Doctor Appointment Calender",

    "appointment" => "Appointment",
    "doctorappointments" => "Doctor Appointments",
    "doctorschedules" => "Doctor Schedules",
    "doctorvisitinvoices" => "Doctor Visit Invoices",
    "diagnosticinvoices" => "Diagnostic Tests Invoices",
    "doctortestpaymentmaster" => "Doctor Test Payment Master",
