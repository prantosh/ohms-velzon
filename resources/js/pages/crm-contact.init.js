...
var idField = document.getElementById("id-field"),
    ...
    customer_nameField = document.getElementById("customer_name-field"),
...
Array.prototype.slice.call(forms).forEach(function (form) {
    form.addEventListener('submit', function (event) {
        if (!form.checkValidity()) {
            ...
            } else if (customer_nameField.value !== "" &&
                company_nameField.value !== "" &&
                email_idField.value !== "" &&
                phoneField.value !== "" &&
                lead_scoreField.value !== "" &&
            ...
            btn.addEventListener("click", function (e) {
                ...
                Array.from(itemValues).forEach(function (x) {
                    ...
                    if (selectedid == itemId) {
                        ...
                        customer_nameField.value = new DOMParser().parseFromString(x._values.name, "text/html").body.querySelector(".name").innerHTML;
