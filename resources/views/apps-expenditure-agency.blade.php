        ...
        <div class="card">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 p-3">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    ...
                    <input type="text" id="searchInput" class="form-control form-control-sm w-auto" placeholder="Search agency...">

                </div>

                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#showModal">
                    <i class="ri-add-line align-bottom me-1"></i>
                    Add Expenditure Agency
                </button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-light p-3">
                <h5 class="modal-title" id="modal-title">Add Expenditure Agency</h5>
            ...
            <form class="tablelist-form">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" id="add-btn">Save Agency</button>
                </div>
...
<script src="{{ URL::asset('build/js/pages/expenditure-agency.init.js') }}"></script>
