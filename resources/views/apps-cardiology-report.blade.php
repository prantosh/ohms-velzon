...
.cardio-study-card textarea:disabled {
...
<div class="card">
    ...
    <div class="card-header">
        <h5 class="card-title mb-0">Cardiology (Echo) Invoices</h5>
    </div>
    ...
    <div class="card-body">
        ...
        <div id="dashNoDataWrap" class="text-muted text-center py-4" style="display:none;">
            No Cardiology (Echo) invoices found for the selected filters.
        </div>
...
<div class="modal fade" id="cardioReportModal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-fullscreen-lg-down modal-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Cardiology (Echo) Report Entry</h5>
            ...
            <div class="modal-body">
                ...
                <div id="noStudiesMsg" class="text-muted" style="display:none;">
                    No Cardiology (Echo) studies found on this invoice.
                </div>
...
<div class="modal fade" id="cardioPreviewModal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-fullscreen-lg-down modal-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                <iframe id="cardioPreviewFrame" style="width:100%; height:80vh; border:none;"></iframe>
            </div>
...
<!-- CARDIOLOGY STUDY CARD TEMPLATE (cloned per line by JS) -->

<template id="cardioStudyCardTemplate">

    <div class="card cardio-study-card mb-3">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control cardio-field"
...
<script src="{{ URL::asset('build/js/pages/cardiology-report.init.js') }}"></script>
