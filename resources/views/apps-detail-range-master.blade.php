    ...
    <div class="d-flex align-items-center gap-3 flex-wrap">
        ...
        <div>
            <input type="text"
                   ...
                   placeholder="Search detail range">
        </div>
        ...
        <div class="modal-content">
            ...
            <form class="tablelist-form" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" id="add-btn">Save Detail Range</button>
...
<script src="{{ URL::asset('build/js/pages/detail-range-master.init.js') }}"></script>
