...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="alert alert-info">
            ...
            Shows every Purchase Order line within a date range.
            <b>Detail</b> lists each PO line. <b>Summary</b> totals quantity/amount by item for the same period.
        </div>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="detailTab" role="tabpanel">
                ...
                <div class="card" id="detailCard" style="display:none;">
                    ...
                    <div class="card-header">
                        <h5 class="card-title mb-0">Purchase Order Detail</h5>
                    </div>
                ...
                <div id="detailNoDataWrap" class="alert alert-warning" style="display:none;">
                    No purchase order lines found for the selected period.
                </div>
...
<script src="{{ URL::asset('build/js/pages/purchase-order-report.init.js') }}"></script>
