...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="alert alert-info">
            ...
            Select a doctor and date to see the settlement/payment status of that doctor's diagnostic test payments
            for the day &mdash; every individual test they're owed for, whether it's been settled, and if so, under
            which settlement voucher.
        </div>
        ...
        <div class="card" id="listCard" style="display:none;">
            ...
            <div class="card-header">
                <h5 class="card-title mb-0">Diagnostic Test Payments</h5>
            </div>
        ...
        <div id="noDataWrap" class="alert alert-warning" style="display:none;">
            No diagnostic test payments found for this doctor on this date.
        </div>
...
<script src="{{ URL::asset('build/js/pages/doctor-test-payment-report.init.js') }}"></script>
