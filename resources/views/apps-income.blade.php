...
@section('title')
    Income from Other Source Entry
@endsection
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h5 class="card-title mb-0" id="formTitle">Record Income from Other Source</h5>
            </div>
                ...
                <form id="incomeForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <label class="form-label">Income from Other Source Category <span class="text-danger">*</span></label>
                            <select id="income_category_id-field" class="form-select" required>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" id="received_from-field" class="form-control" maxlength="150" placeholder="Donor / source name">
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" id="reference_number-field" class="form-control" maxlength="50" placeholder="Receipt book / transaction ref">
                        </div>

                        <div class="col-md-3 mb-3">
                            <label class="form-label">Received By <span class="text-danger">*</span></label>
                            <select id="received_by-field" class="form-select" required>
                                <option value="">-- Select --</option>
        ...
        <div class="card">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 p-3">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    ...
                    <input type="text" id="searchInput" class="form-control form-control-sm w-auto" placeholder="Search invoice / source / reference...">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="confirmIncomeOffcanvas" style="width: 450px;">

    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title">Confirm Income from Other Source Entry</h5>
    ...
    <div class="offcanvas-body">
        ...
        <table class="table table-sm table-bordered mb-4">
            ...
            <tbody>
                ...
                <tr><th>Received From</th><td id="review-received_from"></td></tr>
                ...
                <tr><th>Reference No</th><td id="review-reference_number"></td></tr>
                <tr><th>Received By</th><td id="review-received_by"></td></tr>
        ...
        <div class="d-flex gap-2">
            ...
            <button type="button" class="btn btn-light w-50" id="btnBackToEditIncome">
                Back &amp; Edit
            </button>

            <button type="button" class="btn btn-success w-50" id="btnConfirmSaveIncome">
...
<script src="{{ URL::asset('build/js/pages/income.init.js') }}"></script>
