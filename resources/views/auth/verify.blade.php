                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> ABSSRK. Crafted with <i class="mdi mdi-heart text-danger"></i> by Prantosh Deb</p>
                            </div>
                        </div>
                    </div>
                </div>
