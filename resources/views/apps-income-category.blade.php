...
@section('title')
    Income from Other Source Category Master
@endsection
        ...
        <div class="card">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 p-3">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#showModal">
                    ...
                    Add Income from Other Source Category
                </button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-light p-3">
                <h5 class="modal-title" id="modal-title">Add Income from Other Source Category</h5>
...
<script src="{{ URL::asset('build/js/pages/income-category.init.js') }}"></script>
