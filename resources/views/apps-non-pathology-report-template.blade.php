...
@section('title')
    Non-Pathology Report Template Master
@endsection
...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="alert alert-info">
            ...
            standards before relying on them for real patients. Staff can pick one while entering an X-Ray /
            Endoscopy / EMG-NCV / Dental / EYE / Miscellaneous report and edit the pre-filled text as needed.
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="item_code_sub-field" class="form-select" required>
                                ...
                                <option value="{{ $item->item_code_sub }}">{{ $item->item_description_sub }}</option>
                                @endforeach
                            </select>
...
<script src="{{ URL::asset('build/js/pages/non-pathology-report-template.init.js') }}"></script>
