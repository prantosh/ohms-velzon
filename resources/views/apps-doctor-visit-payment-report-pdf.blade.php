...
@include('partials.pdf-header', ['reportTitle' => 'DOCTOR VISIT PAYMENT REPORT'])
...
<tr>
    <td class="label-blue">Total Visits</td>
...
<tr>
    <th colspan="7" style="text-align:left; background-color:#e6e6e6;">
        {{ $doctor->doctor_name }} &mdash; Doctor Visit Payment Report for {{ $date->format('d-m-Y (l)') }}
    </th>
</tr>
<tr>
    <th>Invoice No</th>
    <th>Patient Name</th>
    <th width="10%">Time</th>
    <th width="12%">Payable</th>
    <th width="12%">Settled</th>
    <th width="12%">Balance</th>
    <th width="16%">Settlement No / Status</th>
</tr>
</thead>
...
@empty
<tr>
    <td colspan="7" class="text-center">No Doctor Visit invoices found for this date.</td>
</tr>
@endforelse
