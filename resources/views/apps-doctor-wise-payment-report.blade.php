...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="alert alert-info">
            ...
            For the selected invoice-date range: every doctor payment due, showing the <b>Payable</b> amount, how
            much has been <b>Settled</b>, and what's still <b>Pending</b>. Use the Doctor filter for a single
            doctor's detail, or leave it on "All Doctors" for the full picture.
        </div>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="summaryTab" role="tabpanel">
                ...
                <div class="row" id="summaryTotalsRow" style="display:none;">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card h-100"><div class="card-body text-center">
                            ...
                            <small class="text-muted">Payment Items</small>
                        </div></div>
                    </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered align-middle">
                                ...
                                <thead class="table-light">
                                    <tr>
                                        <th>Doctor</th>
                                        <th width="110">Items</th>
                                        <th width="130">Gross</th>
                                        <th width="130">Payable</th>
                                        <th width="130">Settled</th>
                ...
                <div id="summaryNoDataWrap" class="alert alert-warning" style="display:none;">
                    No doctor payments found for the selected filters.
                </div>
                            ...
                            <table class="table table-bordered align-middle">
                                ...
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th width="110">Settlement No</th>
                                        <th width="90">Settlement Date</th>
                                        <th>User</th>
                                    </tr>
                                </thead>
...
<script src="{{ URL::asset('build/js/pages/doctor-wise-payment-report.init.js') }}"></script>
